...
export default function ProfileCard({
  ...
  return (
    <div className="bg-void border border-gold/18 rounded-sm p-8 flex flex-col items-center text-center shadow-xl">
      ...
      <h2 className="font-display text-2xl font-light text-ivory mt-4">
        {name}
      </h2>
      <p className="font-interface text-[10px] text-slate font-medium tracking-xs uppercase mt-2">
      ...
      <div className="mt-8 w-full bg-[#0F0F1A] border border-gold/12 rounded-xs p-6 relative overflow-hidden group">
        ...
        <p className="font-interface text-[9px] font-semibold tracking-[3px] uppercase text-slate mb-1">
          Trust Score
        </p>
        <p
