...
export default function FilterBar({ dict }: FilterBarProps) {
  ...
  const activeClass = "bg-primary text-background border-primary";
  const inactiveClass =
    "bg-transparent text-muted-foreground border-primary/20 hover:border-primary/40";
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="relative group">
        ...
        <input
          ...
          className="bg-card border border-primary/15 text-foreground font-interface text-sm ltr:pl-12 ltr:pr-4 rtl:pr-12 rtl:pl-4 py-4 rounded-xs outline-none w-full placeholder:text-muted-foreground/70 transition-all focus:border-primary/50 focus:bg-card/80 shadow-sm"
        />
      </div>
