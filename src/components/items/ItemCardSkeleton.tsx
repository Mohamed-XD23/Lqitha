export default function ItemCardSkeleton() {
  return (
    <div className="flex flex-col rounded-xl bg-card border border-primary/18 animate-pulse">
      {/* Image placeholder */}
      <div className="aspect-video w-full rounded-t-xl bg-background flex items-center justify-center">
        <svg
          viewBox="0 0 16 20"
          fill="currentColor"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
          className="w-10 h-10 text-primary/10"
        >
