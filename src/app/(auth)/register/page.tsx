        ...
        <div className="bg-void border border-gold/18 rounded-sm p-10 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="font-interface text-[11px] font-medium tracking-xs uppercase py-4 rounded-xs bg-gold text-obsidian hover:bg-ivory transition-all disabled:opacity-50 mt-2 flex items-center justify-center min-h-[56px]"
            >
              {loading ? (
