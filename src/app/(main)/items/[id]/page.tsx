    ...
    <div className="bg-obsidian min-h-screen">
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-10 flex items-center gap-4">
          <span
            className={`font-outfit text-[9px] font-bold tracking-xs uppercase px-4 py-1.5 rounded-full border ${
              item.type === "LOST"
          ...
          <span className="font-outfit text-[11px] text-slate tracking-[3px] uppercase font-bold opacity-70">
          ...
          <div className="relative group">
            <div className="aspect-square overflow-hidden rounded-xl bg-void border border-gold/15 shadow-2xl relative z-10">
              {item.imageUrl ? (
                ...
                <div className="flex h-full items-center justify-center text-6xl text-gold/10 bg-linear-to-br from-void to-obsidian">
                  {item.type === "LOST" ? (
          ...
          <div className="flex flex-col gap-8">
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-3">
                    <i
                      className={`fa-solid ${row.icon} text-[10px] text-gold/50`}
                    />
                    <span className="font-outfit text-[10px] uppercase tracking-xs text-slate font-bold">
                      {row.label}
                    </span>
                  </div>
            ...
            <div className="flex items-center gap-4 bg-void border border-gold/15 rounded-xl px-6 py-5 shadow-lg group hover:border-gold/30 transition-all">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="font-outfit text-[10px] text-slate uppercase tracking-xs font-bold">
            ...
            <div className="mt-4">
              {isOwner ? (
                <Link
                  href="/dashboard"
                  className="flex items-center justify-center gap-3 w-full font-outfit text-[11px] font-bold tracking-[3px] uppercase py-4 rounded-full border border-gold/30 text-gold bg-gold/5 hover:bg-gold hover:text-obsidian transition-all duration-300 shadow-lg shadow-gold/5"
                >
                  Manage this Report
        ...
        {isOwner && itemWithClaims && session?.user && (
          <div className="mt-20">
            <div className="mb-8 flex items-center justify-between border-b border-gold/10 pb-4">
              ...
              <span className="bg-gold/10 text-gold border border-gold/20 px-3 py-1 rounded-full text-[12px] font-outfit font-bold uppercase tracking-xs">
