        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-8">
            <div className="space-y-4">
              <h1 className="font-display text-5xl font-light text-ivory leading-[1.1]">
                {item.title}
              </h1>
              <p className="font-interface text-[15px] font-light text-slate leading-relaxed">
                {item.description}
              </p>
            </div>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-interface text-[10px] uppercase tracking-xs text-slate font-bold">
                      {row.label}
                    </span>
                  </div>
                  <span className="font-interface text-sm font-medium text-ivory">
                    {row.value}
                  </span>
                </div>
              ))}
            ...
            <div className="flex items-center gap-4 bg-void border border-gold/15 rounded-xl px-6 py-5 shadow-lg group hover:border-gold/30 transition-all">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="font-interface text-[10px] text-slate uppercase tracking-xs font-bold">
            ...
            <div className="mt-4">
              {isOwner ? (
                <Link
                  href="/dashboard"
                  className="flex items-center justify-center gap-3 w-full font-interface text-[11px] font-bold tracking-[3px] uppercase py-4 rounded-full border border-gold/30 text-gold bg-gold/5 hover:bg-gold hover:text-obsidian transition-all duration-300 shadow-lg shadow-gold/5"
                >
                  Manage this Report
